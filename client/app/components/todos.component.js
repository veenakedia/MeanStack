...
var TodosComponent = (function () {
    ...
    TodosComponent.prototype.addToTodo = function (event, todoText) {
        var _this = this;
        var result;
        var newtodo = {
            text: todoText.value,
        ...
        result.subscribe(function (x) {
            _this._todoService.getTodos().subscribe(function (res) { return _this.todos = res; });
        });
        todoText.value = '';
    };
    ...
    TodosComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.todos = [];
        this._todoService.getTodos().subscribe(function (res) { return _this.todos = res; });
    };
